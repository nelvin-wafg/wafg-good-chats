...
export async function addSubscriberToKit({ email, firstName, linkedinUrl, tag, sourceNote }) {
  ...
  // kit accepts a `tags` array. used to mark "good-chats-lead" signups so you
  // can segment them from regular event opt-ins later.
